...
async function fetchApi(city) {
  ...
  (0,_load__WEBPACK_IMPORTED_MODULE_2__.loading)();
  try {
    ...
    (0,_dom__WEBPACK_IMPORTED_MODULE_0__.weatherCard)(current, forcast);
  } catch {
    (0,_dom__WEBPACK_IMPORTED_MODULE_0__.appendResults)(`<p>Invalid search for "${city}"</p>`);
  }
  (0,_dom__WEBPACK_IMPORTED_MODULE_0__.displayContent)();
  document.querySelectorAll('.degree').forEach((btn) => btn.addEventListener('click', _degree__WEBPACK_IMPORTED_MODULE_1__.changeDegree));
}
