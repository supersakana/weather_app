...
function loadingIcon() {
  ...
  <div role="status" class="h-[80vh] flex items-center justify-center">
    <svg aria-hidden="true" class="w-20 h-20 mr-2 text-gray-100 animate-spin dark:text-gray-500 fill-sky-300" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
